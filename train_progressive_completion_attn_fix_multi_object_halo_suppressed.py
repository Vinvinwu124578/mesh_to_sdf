...
DEFAULT_OUTPUT_DIR = "outputs/progressive_completion_attn_fix_halo_suppressed"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train the halo-suppressed fixed attention-pooled tactile completion variant on a multi-object NPZ dataset."
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.0,
        help="Weight for the optional surface normal consistency loss. Default is disabled for the halo-suppressed setup.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.35,
        help="Fraction of sampled query points biased toward the near-surface band. Lower values strengthen far-field supervision.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.18,
        help="Weight for the touch_zero loss term. Lower values reduce the risk of extra zero-level shells.",
    )
    parser.add_argument(
        "--surface-zero-weight",
        type=float,
        default=0.06,
        help="Weight for the surface_zero loss term. Lower values reduce the risk of extra zero-level shells.",
    )
...
def build_config(args: argparse.Namespace) -> tuple[dict, dict[str, list[str]]]:
    ...
    config = {
        ...
        "loss": {
            ...
            "stage_weights": [0.15, 0.3, 0.4, 0.5, 0.7, 0.85, 1.0],
            "active_focus": 0.5,
