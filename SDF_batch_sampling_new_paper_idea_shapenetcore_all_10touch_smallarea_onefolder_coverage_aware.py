...
from SDF_batch_sampling_new_paper_idea_coverage_aware import (
    process_single_obj_to_merged_npz_coverage_aware,
)
...
def process_shapenetcore_all_categories_custom_onefolder_coverage_aware(
    root_dir,
    category_names=None,
    ...
    output_folder_name="tactistruct_npz_shapenet_10touch_smallarea_onefolder_coverage_aware",
):
...
if __name__ == "__main__":
    ...
    process_shapenetcore_all_categories_custom_onefolder_coverage_aware(
        root_dir=root_dir,
        category_names=None,
