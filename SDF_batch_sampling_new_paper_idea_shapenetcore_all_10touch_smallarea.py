...
def process_shapenetcore_all_categories_custom(
    root_dir,
    category_names=None,
    max_objects_per_category=None,
    num_tactile_samples=10,
    tactile_num_fingers=10,
    tactile_beam_radius=0.06,
    tactile_start_ratio=0.09,
    tactile_end_ratio=0.022,
    tactile_thickness_ratio=0.008,
    tactile_points_per_finger=2500,
    output_folder_name="tactistruct_npz_shapenet_10touch_smallarea",
):
...
if __name__ == "__main__":
    ...
    process_shapenetcore_all_categories_custom(
        root_dir=root_dir,
        category_names=None,
