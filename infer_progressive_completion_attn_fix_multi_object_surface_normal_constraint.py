...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run batch inference for the surface-normal constrained progressive tactile completion project."
    )
    ...
    parser.add_argument(
        ...
        help="Connected-component post-filter applied after marching cubes.",
    )
    parser.add_argument(
        "--boundary-tol-ratio",
        type=float,
...
def main() -> None:
    ...
    default_output_dir = Path(args.checkpoint).resolve().parent / f"progressive_attn_fix_surface_normal_{args.split}_infer"
